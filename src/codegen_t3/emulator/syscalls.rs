...
//   syscall_io.rs   — I/O, strings, floats, time, env (0-16, 60-69, 127-132, 133-135, 200-203, 210-221, 540, 550, 552-553)
...
impl Emulator {
    pub(super) fn do_syscall(&mut self, num: i64) {
        match num {
            ...
            0..=16 | 60..=69 | 127..=130 | 132 | 133..=135 | 200..=203 | 210..=221 | 540
            | 550 | 552..=553 => {
